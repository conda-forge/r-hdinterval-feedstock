...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-hdinterval-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-hdinterval-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-hdinterval-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-hdinterval-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-hdinterval-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-hdinterval-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-hdinterval` can be installed with:

```
conda install r-hdinterval
```

It is possible to list all of the versions of `r-hdinterval` available on your platform with:
